...
BarWidget {
  ...
  function updateHoverState() {
    var hovered = hoverRoot.hovered || hoverHoriz.hovered || hoverInactHoriz.hovered || hoverVert.hovered || hoverInactVert.hovered
  ...
  Item {
    ...
    width: activeVerticalBlock.implicitWidth
    height: activeVerticalBlock.implicitHeight
    ...
    Item {
      ...
      anchors.bottom: activeVerticalBlock.top
